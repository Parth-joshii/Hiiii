...
export const projects = [
  {
    ...
    demoUrl: "http://84.247.140.139:8000/",
  },
  {
    title: "AI Assistant & Hybrid RAG Platform - ShowMeThere (Startup)",
    icon: Sparkles,
    signal: "Production RAG / FAISS & BM25",
    description:
      "Built a production-grade RAG chatbot for ShowMeThere using FastAPI and React 19 with a hybrid search pipeline combining FAISS vector search and BM25 ranking for high-accuracy retrieval.",
    highlights: ["FastAPI", "React 19", "FAISS", "BM25", "MongoDB", "PostgreSQL", "PII Redaction"],
    architecture: ["Query", "FAISS/BM25", "Rerank", "Response"],
    metric: "High-accuracy retrieval",
    githubUrl: profile.github,
    demoUrl: "https://showmetherechatbot.vercel.app/",
  },
  {
    ...
    githubUrl: profile.github,
    demoUrl: "https://imagequalityanalyzer-a8r4nkrl3tvtobsbsn3igk.streamlit.app/",
  },
  {
    ...
    metric: "91% accuracy",
    githubUrl: profile.github,
    demoUrl: "https://medical-recommendation-system-rvzu.onrender.com",
  },
  {
